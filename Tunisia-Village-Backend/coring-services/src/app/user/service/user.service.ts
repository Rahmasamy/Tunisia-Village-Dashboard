...
export class UserService {
    async getUserById(id: bigint) : Promise<Partial<User> | undefined> {
        ...
        return {
            ...
            certificate_pdf_url: user.certificate_pdf_url ?? "",
            certificate_image_url: user.certificate_image_url ?? "",
    ...
    async updateUserProfile(id: bigint, updates: UpdateUserDTO): Promise<Partial<User>> {
        ...
        return {
            ...
            certificate_pdf_url: updatedUser.certificate_pdf_url ?? "",
            certificate_image_url: updatedUser.certificate_image_url ?? "",
