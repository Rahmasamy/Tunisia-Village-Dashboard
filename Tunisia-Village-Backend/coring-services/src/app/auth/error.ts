...
export const PasswordsDoNotMatchError = new AppError("Passwords do not match",400)
export const ServiceNameRequiredError = new AppError("Service name is required for service provider registration", 400);