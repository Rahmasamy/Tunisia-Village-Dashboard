...
export default function RequiredTravelerData() {
  return (
    <div className="space-y-4 text-right animate-in fade-in duration-300" dir="rtl">
      <h2 className="text-2xl font-black text-gray-900">بيانات المسافر المطلوبة</h2>
      <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-3xl p-16 text-center">
        ...
        <p className="text-gray-400 text-sm max-w-sm mx-auto">
          هذا نموذج تجريبي لصفحة (بيانات المسافر المطلوبة). سيتم ربطه بالبيانات لاحقاً.
        </p>
      </div>
    </div>
  );
